; (function ($) {
  ...
  $(".trp-language-switcher .trp-ls-shortcode-language a").each(function() {
        
        if ($(this).text().includes("Vietnamese")) {
            
            $(this).contents().filter(function() {
                return this.nodeType === 3;
            }).each(function() {
                
                this.nodeValue = this.nodeValue.replace("Vietnamese", "Tiếng Việt");
            });
        }
    });


    const categoryName = $(".widget_wpcategorieswidget .danh-muc-dich-vu .cat-item-73 a")
    const categoryCount = $(".widget_wpcategorieswidget .danh-muc-dich-vu .cat-item-73 span")
    if (categoryName && categoryCount) {
        categoryName.attr("href", "/outsource/")
        categoryCount.text('1')
    }
   
  
        $('.trp-ls-shortcode-current-language a').contents().filter(function() {
  ...
  var service = getUrlParameter('service');
    if (service) {
        $("select[name='service']").val(service).change();
    }   
    ...
    $('.widget ul').toggleClass('active-show');

    $('.widget .widget-title').click(function() {
        $(this).toggleClass('active');
        
        if ($(this).closest('.danh-muc-dich-vu').length) {
            $(this).closest('.danh-muc-dich-vu').find('ul').toggleClass('active-show').stop(true, true).slideToggle(300);
        } else {

            $(this).closest('aside').find('ul').toggleClass('active-show').stop(true, true).slideToggle(300);
        }
      setProgressBarCustom()
 
    })

    $('.icon-show-slidebar-js').click(function() {
        $(this).toggleClass('active');

        var body = $('.body-single-js')
        var slidebar = $('.sidebar-single-js')

        
        body.toggleClass('large-9')
        body.toggleClass('large-12')
        slidebar.toggleClass('large-3')
        slidebar.toggleClass('close-slidebar')
      	setProgressBarCustom()
        
    })


    function setProgressBarCustom() {
        const wid_class = ".elementor-element-ad810fa";
        if (wid_class) {
    ...
    $(window).on('load', function () {
        ...
        theme_col_offset();
        softech_header_sticky();
        softech_rtl();
        softech_scroll_to_top();
    });
    ...
    $('.cms-grid').each(function () {
        ...
        $(document).on('click', '.cms-load-more', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'softech_load_more_post_grid',
                    settings: loadmore
                }
            })
                .done(function (res) {
        ...
        $(document).on('click', '.cms-grid-pagination .ajax a.page-numbers', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'softech_get_pagination_html',
    ...
    $(document).ready(function () {
        ...
        /* =================
         Menu Desktop
         =================== */
        $("#main-menu-desktop .open-menu").on('click', function () {
            $(this).toggleClass('opened');
            $('.site-navigation').toggleClass('navigation-open');
        });

        //Btn Close 
        $(".btn-close").on('click', function (menudesktop) {
            menudesktop.preventDefault();
            $(this).parent().removeClass('navigation-open');
        });
        ...
        $('#menu-hidden > .primary-menu > li > a').on('click', function () {
            $(this).parent().find('> .sub-menu').toggleClass('submenu-open');
            $(this).parent().find('> .sub-menu').slideToggle();
        });

        // btn sidebar hidden
        $(document).on('click', '.h-btn-sidebar', function () {
            $('.cms-hidden-sidebar').toggleClass('open');
        });
        $(document).on('click', '.cms-hidden-close', function () {
            $('.cms-hidden-sidebar').toggleClass('open');
        });
        $(".cms-hidden-overlay").on('click', function (e) {
            e.preventDefault();
            $(this).parents('.site').find('.cms-hidden-sidebar').removeClass('open');
        });
    ...
    function theme_col_offset() {
        var w_vc_row_lg = ($('#content').width() - 1300) / 2;
        if (window_width > 1300) {
            ...
            $('body:not(.rtl) .col-offset-left > .elementor-widget-wrap > .elementor-section').css('padding-left', w_vc_row_lg + 'px');
            $('body:not(.rtl) .col-offset-right > .elementor-widget-wrap > .elementor-section').css('padding-right', w_vc_row_lg + 'px');
        }
    }
    function theme_col_offset() {
        var w_vc_row_lg = ($('#content').width() - 1300) / 2;
        if (window_width > 1300) {
            $('body:not(.rtl) .col-offset-left > .style-offset-left > .elementor-widget').css('padding-left', w_vc_row_lg + 'px');
            $('body:not(.rtl) .col-offset-right > .style-offset-right > .elementor-widget').css('padding-right', w_vc_row_lg + 'px');

            $('.rtl .col-offset-left > .style-offset-left > .elementor-widget').css('padding-right', w_vc_row_lg + 'px');
            $('.rtl .col-offset-right > .style-offset-right > .elementor-widget').css('padding-left', w_vc_row_lg + 'px');
    ...
    function softech_header_sticky() {
    ...
    /* ====================
     Scroll To Top
     ====================== */
    function softech_scroll_to_top() {
    ...
    jQuery(document).ready(function () {
        ...
        if ($svgC != '') {
            ...
            triangleGroup.transform("matrix(-0.8615,-0.5077,0.5077,-0.8615,577.307,92.5386)");
            Triangle.attr({
                id: "plane",
