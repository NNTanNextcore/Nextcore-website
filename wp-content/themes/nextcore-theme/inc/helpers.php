...
function nextcore_header_markup() {
    ob_start();
    ?>
    <div class="site-header nextcore-site-header nextcore-native" id="site-header">
        <div class="container header-inner">
            ...
            <div id="nextcore-mobile-panel" class="nextcore-mobile-panel">
                ...
                <div class="nextcore-mobile-actions"><?php get_template_part('template-parts/global/language-switch'); ?><?php get_template_part('template-parts/global/theme-switch'); ?></div>
            </div>
        </div>
    </div>
    <?php
...
function nextcore_header_shortcode() {
    return nextcore_header_markup();
}
add_shortcode('nextcore_header', 'nextcore_header_shortcode');
