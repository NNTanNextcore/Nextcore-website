...
function nextcore_setup() {
    ...
    register_nav_menus(array(
        ...
        'footer_nextcore' => __('Footer - Nextcore', 'nextcore-theme'),
        'footer_services' => __('Footer - Dịch vụ', 'nextcore-theme'),
        'footer_explore' => __('Footer - Khám phá', 'nextcore-theme'),
        'footer_connect' => __('Footer - Kết nối', 'nextcore-theme'),
    ));
}
add_action('after_setup_theme', 'nextcore_setup');

function nextcore_register_elementor_locations($elementor_theme_manager) {
    $elementor_theme_manager->register_all_core_location();
}
add_action('elementor/theme/register_locations', 'nextcore_register_elementor_locations');
