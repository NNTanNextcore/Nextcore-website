...
Nextcore không chỉ là một đối tác, mà còn là một người bạn đồng hành đáng tin cậy trên hành trình phát triển của chúng tôi!',
    ...
    'nc_technology_items' => array(
        array('mark' => 'drupal', 'label' => 'Drupal'),
        array('mark' => 'salesforce', 'label' => 'Salesforce'),
        array('mark' => 'sitecore', 'label' => 'Sitecore'),
        array('mark' => 'python', 'label' => 'Python'),
        array('mark' => 'csharp', 'label' => 'C#'),
        array('mark' => 'java', 'label' => 'Java'),
        array('mark' => 'php', 'label' => 'PHP'),
        array('mark' => 'javascript', 'label' => 'JavaScript'),
        array('mark' => 'apex', 'label' => 'Apex'),
        array('mark' => 'mysql', 'label' => 'MySQL'),
        array('mark' => 'postgresql', 'label' => 'PostgreSQL'),
        array('mark' => 'sqlite', 'label' => 'SQLite'),
        array('mark' => 'db2', 'label' => 'DB2'),
        array('mark' => 'flask', 'label' => 'Flask'),
        array('mark' => 'dotnet', 'label' => '.NET'),
        array('mark' => 'laravel', 'label' => 'Laravel'),
        array('mark' => 'react', 'label' => 'React'),
        array('mark' => 'vue', 'label' => 'Vue'),
        array('mark' => 'aws', 'label' => 'AWS'),
        array('mark' => 'azure', 'label' => 'Azure'),
        array('mark' => 'gcp', 'label' => 'Google Cloud'),
        array('mark' => 'windows', 'label' => 'Windows'),
        array('mark' => 'ubuntu', 'label' => 'Ubuntu'),
        array('mark' => 'centos', 'label' => 'CentOS'),
    ),
