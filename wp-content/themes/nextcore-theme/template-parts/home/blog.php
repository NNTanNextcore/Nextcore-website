        ...
        <?php while ($posts->have_posts()) : $posts->the_post(); ?>
            <article class="blog-card" data-reveal>
                <?php if (has_post_thumbnail()) : ?>
                    <a class="blog-image-link" href="<?php the_permalink(); ?>" aria-label="<?php echo esc_attr(get_the_title()); ?>">
                        <?php the_post_thumbnail('medium_large', array('loading' => 'lazy')); ?>
                    </a>
                <?php endif; ?>
                <div>
                    <span class="post-meta"><?php $categories = get_the_category(); if ($categories) { echo esc_html($categories[0]->name); } ?></span>
