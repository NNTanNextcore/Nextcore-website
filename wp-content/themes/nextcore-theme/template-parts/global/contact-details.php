...
?>
<address>
<p><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 10c0 6-8 12-8 12S4 16 4 10a8 8 0 1 1 16 0Z"/><circle cx="12" cy="10" r="2.5"/></svg><span><?php echo esc_html(nextcore_option('nc_contact_address', __('63 Phan Đăng Lưu Street, Hai Chau, Da Nang 550000, Viet Nam', 'nextcore-theme'))); ?></span></p>
