    ...
    public static function defaultApps()
    {
        ...
        $apps =  array(
            'facebook-messenger' => array(
                ...
                'title' => __('Messenger', 'support-chat'),
                'shortcode' => 'wpsaio_facebook_messenger',
                'params' => array(
                    'url' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('URL', 'support-chat'),
                        'desc' => __('Example: http://facebook.com/ninjateam.org/', 'support-chat'),
                    ),
                ),
            ),
            'whatsapp' => array(
                ...
                'title' => __('WhatsApp', 'support-chat'),
                'shortcode' => 'wpsaio_whatsapp',
                'params' => array(
                    'phone' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Phone Number', 'support-chat'),
                        'desc' => __('Example: +1 (800) 123-4567', 'support-chat'),
                    ),
                ),
            ),
            'snapchat' => array(
                ...
                'title' => __('Snapchat', 'support-chat'),
                'shortcode' => 'wpsaio_snapchat',
                'params' => array(
                    'username' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Username', 'support-chat'),
                        'desc' => __('Example: ninjateam', 'support-chat'),
                    ),
                ),
            ),
            'line' => array(
                ...
                'title' => __('Line', 'support-chat'),
                'shortcode' => 'wpsaio_line',
                'params' => array(
                    'url' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('QR Code URL', 'support-chat'),
                        'desc' => __('Example: http://line.me/ti/p/xxx', 'support-chat'),
                    ),
                ),
            ),
            'viber' => array(
                ...
                'title' => __('Viber', 'support-chat'),
                'shortcode' => 'wpsaio_viber',
                'params' => array(
                    'account' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Public Account', 'support-chat'),
                        'desc' => __('Example: NinjaTeam', 'support-chat'),
                    ),
                ),
            ),
            ...
            'email' => array(
                ...
                'title' => __('Email', 'support-chat'),
                'shortcode' => 'wpsaio_mail',
                'params' => array(
                    'email' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Email', 'support-chat'),
                        'desc' => __('Example: support@ninjateam.org', 'support-chat'),
                    ),
                ),
            ),
            'telegram' => array(
                ...
                'title' => __('Telegram', 'support-chat'),
                'shortcode' => 'wpsaio_telegram',
                'params' => array(
                    'username' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Telegram account', 'support-chat'),
                        'desc' => __('Example: ninjateam', 'support-chat'),
                    ),
                ),
            ),
            'skype' => array(
                ...
                'title' => __('Skype', 'support-chat'),
                'shortcode' => 'wpsaio_skype',
                'params' => array(
                    'username' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Skype account', 'support-chat'),
                        'desc' => __('Example: ninjateam', 'support-chat'),
                    ),
                ),
            ),
			...
			c1.37,0,2.49,1.12,2.49,2.49C23.53,14.1,22.41,15.22,21.04,15.22z"/></svg>',
                'title' => __('Zalo', 'support-chat'),
                'shortcode'=> 'wpsaio_zalo',
                'params' => array(
                    'username' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Zalo account', 'support-chat'),
                        'desc' => __('Example: ninjateam', 'support-chat'),
                    ),
                ),
            ),
		...
		l-1.71,1.71l1.85,2.45C22.5,13.76,22.56,13.96,22.53,14.16z"/></svg>',
                'title' => __('Kakaotalk', 'support-chat'),
                'shortcode'=> 'wpsaio_kakaotalk',
                'params' => array(
                    'username' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Kakaotalk account', 'support-chat'),
                        'desc' => __('Example: ninjateam', 'support-chat'),
                    ),
                ),
            ),
		...
		c-0.12,0.44-0.46,0.79-0.9,0.9V9.08z"/></svg>',
                'title' => __('Wechat', 'support-chat'),
                'shortcode'=> 'wpsaio_wechat',
                'params' => array(
                    'email' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Wechat account', 'support-chat'),
                        'desc' => __('Example: support@ninjateam.org', 'support-chat'),
                    ),
                ),
            ),
            'custom-app' => array(
                ...
                'title' => __('Custom App', 'support-chat'),
                'shortcode' => 'wpsaio_custom_app',
                'params' => array(
                    'url' => array(
                        'type' => 'text',
                        'required' => true,
                        'placeholder' => __('Enter your URL', 'support-chat'),
...
?>
        <div class="wp_saio_panel_wrap">
            <p><?php echo __('Select app icons to add them to your list.', 'support-chat') ?></p>
            <?php
            foreach ($apps as $k => $v) {
        ...
        <div style="margin-bottom: 25px">
            <a href="javascript:void(0)" class="button" id="add-new-custom-app"><?php echo __('Add New App', 'support-chat') ?></a>
        </div>
        ...
        <div class="wp_saio_panel_btn-wrap">
            <button class="wpsaio-save button button-primary button-choose-apps"><?php echo __('Save Changes', 'support-chat') ?><i class="dashicons dashicons-update-alt"></i></button>
        </div>
<?php
    }
