...
<section class="technology section-border" id="technology" aria-labelledby="technology-title"><div class="container technology-inner">
      <div><p class="eyebrow"><?php echo esc_html(nextcore_field('nc_technology_eyebrow', 'Công nghệ')); ?></p><h2 id="technology-title"><?php echo nl2br(esc_html(nextcore_field('nc_technology_heading', "Nền tảng\n tạo nên khác biệt"))); ?></h2></div>
