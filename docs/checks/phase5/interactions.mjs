...
try {
 ...
 await send('Page.navigate',{url:origin+'/docs/checks/phase5/rendered-plugins.html'}); await delay(1200);
 ...
 await send('Page.navigate',{url:origin+'/docs/checks/phase5/rendered-plugins-en.html'});await delay(800);
